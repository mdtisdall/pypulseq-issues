...
| # | Issue | Status | Upstream |
|---|---|---|---|
| 01 | [`make_arbitrary_grad(oversampling=True)` checks the slew rate 4× too leniently](01-oversampled-slew-check/issue.md) | draft | — |
...
- `issue.md`: the report, ready to paste into a GitHub issue.
